...
public class UEC extends AppCompatActivity {
    ...
    public void onClickCheck(View view){
        ...
        if (bm.toString() == "B" || bm.toString() == "A") {
            passcount++;
        }

        if (bi.toString() == "B" || bi.toString() == "A") {
            passcount++;
        }

        if (math.toString() == "B" || math.toString() == "A") {
            passcount++;
        }

        if (sc.toString() == "B" || sc.toString() == "A") {
            passcount++;
        }

        if (sj.toString() == "B" || sj.toString() == "A") {
            passcount++;
        }

        if (phy.toString() == "B" || phy.toString() == "A") {
            passcount++;
        }

        if (che.toString() == "B" || che.toString() == "A") {
            passcount++;
        }

        if (addmath.toString() == "B" || addmath.toString() == "A") {
            passcount++;
        }

        if(passcount >= 3 || bi.toString() == "C" || bi.toString() == "B" || bi.toString() == "A" || math.toString() == "B" || math.toString() == "A"){
